...
<body>
    ...
    <div id="wrap" align="center">
		...
		<form action="write?pageNum=1" method="post" enctype="multipart/form-data">
			<table class="type05">
            	<tr>
                ...
                <tr>
                    ...
                    <td><input type="text" class="writetxt" name="bname" size="10" value="${ainfo.a_name}"></td>
                    <th scope="row" style="text-align: center;">작성 날짜</th>
                    <td><%=strdate%></td>
                </tr>
                <tr>
                	<th scope="row" style="text-align: center;">제목</th>
                    <td colspan="5"><input type="text" class="writetxt" id='btitle' name="btitle" size = "70"> * 필수</td>
                </tr>
                <tr>
                	<th scope="row" style="text-align: center;">첨부파일</th>
                    <td colspan="5"><input type="file" multiple="multiple" name="bfile"></td>
                </tr>
                <tr>
                	<th scope="row" style="text-align: center;  padding: 100px 0px;">내용</th>
                    <td colspan="5"><textarea id="bcontent" cols="130" rows="15" name="bcontent" placeholder="내용 500자 이내로 작성해주세요!!" style="resize:none"></textarea>
