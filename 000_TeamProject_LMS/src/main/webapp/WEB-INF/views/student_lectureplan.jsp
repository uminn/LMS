		...
		<form action="lec_write" method="post" id="lec">
		    ...
		    <table class="type05">
		            ...
		            <td>
		                <table id="plan_content">
		                    <tr>
		                        ...
		                        <td><input type="text" class="writetxt week" name="lec_week1" value="${lec_list.lec_week1}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">2주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week2" value="${lec_list.lec_week2}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">3주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week3" value="${lec_list.lec_week3}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">4주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week4" value="${lec_list.lec_week4}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">5주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week5" value="${lec_list.lec_week5}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">6주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week6" value="${lec_list.lec_week6}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">7주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week7" value="${lec_list.lec_week7}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">8주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week8" value="${lec_list.lec_week8}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">9주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week9" value="${lec_list.lec_week9}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">10주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week10" value="${lec_list.lec_week10}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">11주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week11" value="${lec_list.lec_week11}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">12주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week12" value="${lec_list.lec_week12}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">13주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week13" value="${lec_list.lec_week13}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">14주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week14" value="${lec_list.lec_week14}" disabled size = "105"></td>
		                    </tr>
		                    <tr>
		                        <td class="plan_title">15주차</td>
		                        <td><input type="text" class="writetxt week" name="lec_week15" value="${lec_list.lec_week15}" disabled size = "105"></td>
		                    </tr>
		                </table>
		            </td>
		        </tr>
		        ...
		        <tr>
		            ...
		            <td>
		                <table>
		                    ...
		                    <tr>
		                        <td class="lecturetxt01"><input type="text" class="lecturetxt  week" name="lec_mid" value="${lec_list.lec_mid}" style="text-align: center" disabled></td>
		                        <td class="lecturetxt01"><input type="text" class="lecturetxt week" name="lec_final" value="${lec_list.lec_final}" style="text-align: center" disabled></td>
		                        <td class="lecturetxt01"><input type="text" class="lecturetxt week" name="lec_homework" value="${lec_list.lec_homework}" style="text-align: center" disabled></td>
		                        <td class="lecturetxt01"><input type="text" class="lecturetxt week" name="lec_active" value="${lec_list.lec_active}" style="text-align: center" disabled></td>
		                        <td class="lecturetxt01"><input type="text" class="lecturetxt week" name="lec_attendance" value="${lec_list.lec_attendance}" style="text-align: center" disabled></td>
		        ...
		        <tr>
		            ...
		            <td><input type="text" class="writetxt" name="lec_book" value="${lec_list.lec_book}" size = "70" disabled></td>
		        </tr>   
		    </table>
